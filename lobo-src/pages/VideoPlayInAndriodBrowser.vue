                ...
                <div class="video-part">
                    ...
                    <!--<div class="operations">-->
                        <!--<div class="like-info">-->
                            ...
                            <!--&lt;!&ndash;<span>{{videoInfo.praiseTimes}}</span>&ndash;&gt;-->
                            <!--<span>55</span>-->
                        <!--</div>-->
                        <!--<img src="../assets/image/icon/button/icon_share.png" class="share-video" @click="clickToShare">-->
                        <!--<img src="../assets/image/icon/button/icon_video_call.png" class="video-call" @click="clickToDownload">-->
                    <!--</div>-->
                </div>
            </swiper-item>
        </swiper>
